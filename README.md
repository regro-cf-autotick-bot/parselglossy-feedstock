...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/parselglossy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11235&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/parselglossy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `parselglossy` can be installed with:

```
conda install parselglossy
```

It is possible to list all of the versions of `parselglossy` available on your platform with:
